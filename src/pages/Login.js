              ...
              <div className="lg:flex lg:flex-wrap g-0">
                <div className="lg:w-6/12 px-4 md:px-0">
                  <div className="md:p-12 md:mx-6">
                    <div className="text-left text-2xl font-bold">
                      <span className="text-green-600 p-2">Brgy.Manuyo</span>Uno
                    </div>
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        <span className='mt-4 font-semibold block'>Login to Admin Dashboard</span>
                            <div>
                            ...
                            <div>
                                ...
                                <input 
                                      ...
                                      value={password}
                                      className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 -white " 
                                      placeholder="••••••••"
                                      required 
                                />
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 pb-5 sm:pb-0">
                                Dont have an account yet? &nbsp;
                                <Link to="/signup" className="font-medium text-green-600 hover:underline ">Create Account</Link>
                            </p>
                    </form>
                  </div>
                </div>
                ...
                >
                  <div className="text-gray-700 px-4 py-6 md:p-12 md:mx-6 ">
                    <h4 className="text-3xl font-semibold mb-6">Waste is worse than loss</h4>
                    <p className="text-meduim text-gray-700">
                    The time is coming when every person
                     who lays claim to ability will keep the question of waste before him constantly.
